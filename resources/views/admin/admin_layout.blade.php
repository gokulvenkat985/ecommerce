...
<!-- data table css -->
  ...
  <body>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">matagories</span>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('newslater') }}" class="nav-link"> News later</a></li>
        </ul>
    ...
    // code to read selected table row cell data (values).
                ...
                $("#datatable3").on('click','.btnSelect2',function(){
                     // get the current row
                     var currentRow=$(this).closest("tr"); 
